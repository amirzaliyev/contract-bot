        ...
        **kwargs: Any
        ...
        for btn_kwargs in buttons:
            ...
            if isinstance(builder, InlineKeyboardBuilder):
                if not any(key in btn_kwargs for key in {"callback_data", "url", "switch_inline_query"}):
                    raise ValueError(
                    "Inline keyboard buttons must include at least one of 'callback_data', 'url', or 'switch_inline_query'"
                    )
